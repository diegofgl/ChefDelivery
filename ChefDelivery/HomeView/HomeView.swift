...
struct HomeView: View {
    ...
    @State private var schowSecondScreen = false
    ...
    var body: some View {
        ...
        GeometryReader { geometry in
            ZStack {
                ...
                VStack {
                    ...
                    Image("image")
                        ...
                        .gesture(
                            DragGesture()
                                .onChanged({ gesture in withAnimation(.easeInOut(duration: 1.5)) {
                                    imageOffset = gesture.translation
                                }
                                })
                                .onEnded({ _ in withAnimation(.easeInOut(duration: 1.5)) {
                                    imageOffset = .zero
                                }
                            })
                        )
            ...
            .fullScreenCover(isPresented: $schowSecondScreen) {
                ContentView()
            }
        }
    }
